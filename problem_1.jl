...
# ╔═╡ 61ecf092-c3ad-4290-a215-274ff30e629d
using PlutoUI

# ╔═╡ f0dd50b1-9d64-4f8c-8799-65795ebc71a8
using CSV

# ╔═╡ 5e48bc4e-7c9b-4584-ad2a-f0975611ddc9
using DataFrames

# ╔═╡ 205c4593-5174-49a4-9e71-fbd1f1f2c5a9
using Clustering

# ╔═╡ 39ba61b3-913d-4ecd-a8ec-0c6aa6c5e21b
using MLJClusteringInterface

# ╔═╡ 8db2a12c-1312-4492-9b81-0d504d8f8ccb
using Distances

# ╔═╡ e0e5f284-f6a9-4ad1-bb09-f8329a79e93e
using StatsBase

# ╔═╡ 54c9bb0a-0adb-481c-a25e-8a9cd010da74
using Plots

# ╔═╡ 5e237492-262f-4091-88bb-01b5feaa1e6f
using XLSX

# ╔═╡ f7d65e36-7946-4693-a415-bc0c617368b5
using StatsPlots

# ╔═╡ 1023ce85-7146-4d43-beb5-1def56644035
using MultivariateStats

# ╔═╡ 49f259fc-a977-4fb4-be5b-15ef4b5b5d14
using MLBase

# ╔═╡ c4855103-e05e-4d7f-ac49-ae48fb3e2b00
using MLJMultivariateStatsInterface

# ╔═╡ 6ca7e81f-8881-4fae-b7cc-14b963d1fc58
using MLJ

# ╔═╡ 7e7be015-a1e4-4c06-8e3d-f0d39e571ea2
using BetaML

# ╔═╡ 50a56986-206d-467d-aa50-65ae2bf7aab8
md"## Data Cleaning"

# ╔═╡ a5119661-32b9-4a4e-a914-5caf22f10a74
dia_data = DataFrame(CSV.File("C:/Users/paulu/Desktop/NUST - 2025 (Masters of Data Science)/Artificial Intelligence and ML/Assignment 2/dia.csv", header=1))
...
# ╔═╡ 8b098128-0aca-4150-a0d4-65a6c34b70a8
X = dia_data[:, 2:end]
...
# ╔═╡ 15c27435-9824-413a-8738-312ee8db7f3c
model = Standardizer() |> KMeans(k=2)

# ╔═╡ 8fa7a8d7-8cd2-4b1d-a209-ce35a86809c9
mach = machine(model, X)

# ╔═╡ c3916890-2beb-43c2-b222-c41a9c6513c7
...
# ╔═╡ 2e7a7af7-d280-45b0-be68-10e02b072707
PCA = @load PCA pkg=MultivariateStats verbosity=0

# ╔═╡ f367a259-e9a1-4b35-b76f-1a5e97e3e0ef
amc_model = HierarchicalClustering(linkage = :complete, metric=SqEuclidean())

# ╔═╡ de214808-47c0-487a-b7a7-fcabe51c6b52
dia_pca_model = PCA(maxoutdim=2,variance_ratio=1)

# ╔═╡ 89afd057-1d97-41b6-b899-59f61f776b2b
dia_pca_mach = machine(dia_pca_model, X)

# ╔═╡ 37c301b5-52c5-44cc-bb29-9bf7cb3fe89b
MLJ.fit!(dia_pca_mach, force=true)

# ╔═╡ 3ca616c2-fb35-497b-bc4e-a8257f9473ba
X_pca = MLJ.transform(dia_pca_mach, X)

# ╔═╡ 93086a59-c47e-4c9c-9daf-d937a50a7fec
...
# ╔═╡ 9d043e01-477b-4109-945b-7fbdd92509e0
cluster_ids = convert(Vector{Int}, cluster_labels)

# ╔═╡ 6a10299b-687a-4313-b327-1aeecfa6acaf
rpt2 = report(amc_mach)

# ╔═╡ bf15e0b6-f96c-452f-b1bd-03dea1323472
plot(rpt2.dendrogram)

# ╔═╡ 13351445-d759-490b-9ab4-ff95149071ab
report(amc_mach).cutter(h = 30)

# ╔═╡ cc44a843-a97d-4523-8c0a-33fedde5ea8f
X_pca_matrix = Matrix(X_pca)

# ╔═╡ e9b848d2-0958-4995-b05e-cae66093e279
...
# ╔═╡ 3ee2dc67-5ff3-468b-a24c-7de730d6afa0
GMM   = @load GaussianMixtureClusterer pkg = "BetaML" verbosity=0

# ╔═╡ eec67fcc-547b-43dd-8d98-7426de23eba9
std_model = Standardizer()

# ╔═╡ 1a061849-4ef8-41fd-a2a5-5efa493a37c9
...
println("KMeans Silhouette Score: ", mean(sil_scores))

# ╔═╡ 1fd98f75-a761-4647-aa41-63f6f2c24e21
println("Agglomerative Hierarchical Silhouette Score: ", mean(hc_sils_score))

# ╔═╡ a667949d-d223-4719-b006-58ef93e6c4a1
println("Gaussian Mixture Model Log-likelihood: ", MLJ.fit!(gmm_machine))

# ╔═╡ 8f9c3be1-ffd2-4ee4-901e-9497eb9e6b20
md"#### Which algorithm yields the best clusters? Why?"
...
manifest_format = "2.0"
project_hash = "abf9b1ba9dcfee501542eca016a71772ed8c594a"
